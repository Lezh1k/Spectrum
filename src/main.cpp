...
//    SoundCallbackProcessor::instance().handle_new_peace_of_sound_1(pcm_data.data() + i, 960);
    SoundCallbackProcessor::instance().handle_new_peace_of_sound_0(pcm_data.data() + i, 960);
  }
